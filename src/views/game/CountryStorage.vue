          ...
          <el-table-column label="取出" align="center" :width="150">
            <template slot-scope="scope">
              ...
              <el-button
                type="primary"
                size="mini"
                @click="take_item_from_country_storage({ item: scope.row.id, number: scope.row.select_number })"
              >
                取出
              </el-button>
            </template>
          ...
          <el-table-column label="存入" align="center" :width="150">
            <template slot-scope="scope">
              ...
              <el-button
                type="primary"
                size="mini"
                @click="put_item_to_country_storage({ item: scope.row.id, number: scope.row.select_number })"
              >
                存入
              </el-button>
            </template>
